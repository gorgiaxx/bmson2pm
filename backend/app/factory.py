...
DEFAULT_LANES = [
    Lane(id=1, code="head_simultaneous", display_name="鼓面同时击打", color="#f2aa4f", hand="both"),
    Lane(id=2, code="rim_single", display_name="鼓缘单击", color="#dc84d8", hand="either"),
    Lane(id=3, code="rim_simultaneous", display_name="鼓缘同时击打", color="#62a6e8", hand="both"),
    Lane(id=4, code="small_right", display_name="右小鼓", color="#e96978", hand="right"),
    Lane(id=5, code="small_left", display_name="左小鼓", color="#40c4b4", hand="left"),
